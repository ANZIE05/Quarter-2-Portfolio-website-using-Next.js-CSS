export default function AboutPage (){
    ...
    <div>
      ...
      <div className="about-container">
        <h2 className="heading">About Me</h2><br/><br/>
        <p>Hello! I'm Qurat Ul Ain, a Graphic Designer and Digital Marketing specialist with a solid foundation in MS Office. My journey has been driven by a love for creativity, innovation, and a focus on delivering tailored solutions for each project. Currently, I'm expanding my skill set by learning front-end development, aiming to enhance the user experience through seamless, interactive design.<br/>
        ...
        &nbsp;&nbsp;&nbsp;Whether I'm designing visuals or building a website, I approach each task with enthusiasm and commitment to quality.
        </p>
        <br/>
        <br/>
        <br/>

        <a href="#"className="btn1">Download Resume</a>
